...
In the following subsections, I explore a variety of metrics for both class-based and free-form VQA tasks as outlined in Table \ref{tab:vqa_metrics_suitability}, focusing on how they compare semantically similar answers.
...
\begin{itemize}
    \item DAQUAR Average and min consensus accuracy
    \item VQA Consensus Accuracy (most widely used)
\end{itemize}
