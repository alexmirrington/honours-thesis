...
\centering
    ...
    \end{xltabular}
    \caption[A comparison of VQA metrics]{A comparison of metrics and their suitability for various VQA tasks.}
    \label{tab:vqa_metrics}
\end{table}
...
By default, \textsc{Bleu} is defined as the brevity penalty multiplied by the geometric mean of \(n\)-gram precisions \(p_n\) for \(n \in [1, 4]\):
