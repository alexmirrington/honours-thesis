...
\begin{enumerate}
    ...
    \item The goal of the scene graph module is to capture dependencies between objects, attributes and relations. These dependencies are readily captured by existing node-based graph convolutional layers like GCN and GAT layers, however, to utilise these methods, all features that may be relevant to question answering must be represented as node features.
\end{enumerate}
